 ...
 *
 * Source: Drupal-8.X: /core/lib/Drupal/Component/Utility/Crypt.php !
 *
 * @ingroup utility
 */
class Crypt {
  ...
  /**
   * Short alias for randomBytesBase64().
   */
  public static function rnd(int $len = 12) {
    return self::randomBytesBase64($len);
  }
